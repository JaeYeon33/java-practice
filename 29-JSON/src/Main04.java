...
/**
 *  JSON 데이터를 Java Beans 객체로 변환하기
 */
public class Main04 {
    public static void main(String[] args) {
        // 파일로부터 JSONObject 객체 생성
        String source = FileHelper.getInstance().readString("29-JSON/src/res/04.json", "utf-8");
        /** 데이터에 계층적으로 접근한다. */
        ...
        /** 추출한 데이터를 Beans의 객체로 재구성 -> 외부 데이터를 Java의 데이터 규격으로 변환 */
